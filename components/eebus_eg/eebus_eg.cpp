...
static void spine_event_handler(const EventPayload* payload, void* ctx) {
  ...
  /* The openeebus event bus is process-global: both EG instances receive every
   * SPINE event, even events generated by the other instance's SHIP session.
   * Guard here so each instance only processes events relevant to itself. */
  {
